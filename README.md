# image_z_image_turbo-1-1-1-json

Dockerized ComfyUI workflow: image_z_image_turbo (1) (1) (1).json
...
docker build -t image_z_image_turbo-1-1-1-json .

# Run the container
docker run -p 8188:8188 image_z_image_turbo-1-1-1-json
```
